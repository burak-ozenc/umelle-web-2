const TestimonialsCarouselData1 = [
    ...
    },
    {
        ...
        list: [
            ...
            {
                listMember : 'Commitment'
            },
            {
                listMember : 'Innovation'
            }
        ]
    },
    {
        ...
        list: [
            ...
            {
                listMember : 'Impeccable Delivery'
            },
            {
                listMember : 'Handpicked Talent'
            }
        ]
    }
]
...
const TestimonialsCarouselData5 = [
    {
        firstname: "harvard",
        lastname: "Alexander",
        designation: "Microsoft Design",
        content: "This theme has a wide variety of options and a really good customer support. But even so, the theme still gives a lot of features while prioritizing web speed.",
    ...
    },
    {
        ...
        lastname: "Rose",
        designation: "Creative director",
        content: "Trust us we looked for a very long time and wasted thousands of dollars testing other teams, freelancers, and outsource companies. Excellent company!",
        img: "https://via.placeholder.com/359x359"
    },
    {
        firstname: "Jonsan",
        ...
        content: "Their team are easy to work with and helped me make amazing websites in a short amount of time. Thanks guys for all your hard work. Professional support.",
        img: "https://via.placeholder.com/359x359"
    }
]

const TestimonialsCarouselData6 = [
    {
        firstname: "Alexander",
        lastname: "harvard",
        designation: "Creative director",
...
const TestimonialsCarouselData7 = [
    {
        firstname: "Shoko",
        lastname: "mugikura",
...
const TestimonialsCarouselData8 = [
    {
        firstname: "Colin",
        lastname: "Powell",
...
export { TestimonialsCarouselData1, TestimonialsCarouselData2, TestimonialsCarouselData3, TestimonialsCarouselData4, TestimonialsCarouselData5, TestimonialsCarouselData6, TestimonialsCarouselData8, TestimonialsCarouselData7, TestimonialsCarouselData9 }