...
import {InteractiveBannersData18} from "../../../Components/InteractiveBanners/InteractiveBannersData";
...
const FeaturesData = [
    {
        ...
        content: "Our team is proficient in the latest AI and machine learning technologies, ensuring you receive innovative and effective solutions.",
    },
    {
        ...
        content: "We tailor AI implementations to meet your specific business needs, ensuring maximum impact and ROI.",
    },
    {
        ...
        content: "Our AI solutions are designed to scale with your business, providing flexibility and adaptability.",
    },
    {
        icon: "line-icon-Talk-Man text-basecolor text-[40px] text-gradient bg-gradient-to-r from-[#975ade] via-[#af63d2] to-[#e6686f]",
        title: "Proven Success",
        content: "We have a track record of successfully deploying AI solutions that drive business growth and efficiency.",
    }
]

const AISolutions = (props) => {
    ScrollToAnchor();
    ...
    return (<div style={props.style}>
                    ...
                    <Row
                        ...
                        <Col xs={12} lg={6} md={6}
                            ...
                            <m.h4 initial={{clipPath: 'polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)'}}
                                ...
                                Unlock Business Potential with AI and Machine Learning
                            </m.h4>
                            <m.span initial={{clipPath: 'polygon(0% 0%, 100% 0%, 100% 0%, 0% 0%)'}}
                                ...
                                Drive smarter decisions and automate processes with Umelle's AI and machine learning solutions. Harness the power of predictive analytics, natural language processing, and real-time automation to enhance efficiency and foster innovation within your organization.
                            </m.span>
                        </Col>
                        <Col xs={12} lg={6} md={6}
      ...
      {/* Section End */}
                    ...
                    <Container>
                        <Row className="justify-center">
                            <Col lg={6} sm={8} className="text-center mb-24 md:mb-16 sm:mb-8 mt-14">
                                ...
                                <h2 className="heading-4 font-serif font-light text-darkgray tracking-[-1px]">Get Smart Data</h2>
                            </Col>
            ...
            <section className="py-[60px] lg:py-[60px] md:py-[95px] sm:py-[80px] xs:py-[50px] bg-lightgray">
                ...
                <h6 className="font-serif text-gray-900 text-center font-medium mb-[91px] xl:mb-[105px] lg:mb-[74px] md:mb-[65px] sm:mb-[53px] xs:mb-[46px] xxs:mb-[40px]">Unlock Hidden Potential In Your Data</h6>
                <InteractiveBanners04
                    grid="row-cols-12 gap-y-10 sm:justify-center"
                    overlay={["#0039e3cc", "#4132e0cc", "#5e28ddcc", "#741bd9cc", "#8600d4cc"]}
                    data={InteractiveBannersData18}
                    animation={fadeIn} />
                </Container>
            </section>
            {/* Section End */}
