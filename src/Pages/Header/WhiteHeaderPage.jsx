    ...
    return (
        <>
            ...
            <Header topSpace={{desktop: true}} type="reverse-scroll">
                <HeaderNav theme="light" bg="white" menu="light" expand="lg"
                           className="px-[35px] py-[0px] lg:px-[15px] md:px-0" containerClass="sm:px-0">
                        ...
                        <Link aria-label="header logo" className="flex items-center" to="/">
                            <Navbar.Brand className="inline-block p-0 m-0">
                                <img className="default-logo" width="111" height="36" loading="lazy"
                                     ...
                                     data-rjs='/assets/img/webp/logo-fast-blue-black@2x.webp' alt='logo'/>
                    ...
                    <Row className="full-screen md:h-[650px] sm:h-[550px] xs:h-[450px]">
                        <Col md={5} sm={7} className="flex flex-col py-32">
                            ...
                            <div className="flex font-serif items-center font-medium text-xmd text-darkgray mt-auto">
                                <span
                                    className="flex-shrink-0 h-[2px] w-[20px] bg-darkgray item-center mr-[15px]"></span>
                                <div className="grow tracking-[-.5px]">
